...
def small_config() -> JTDeepseekV3Config:
    ...
    config.jt_config = {"num_nextn_predict_layers": 1, "seq_length": 8, "qk_rope_head_dim": 4,
                         "rope_theta": 10000.0, "n_routed_experts": 4, "num_experts_per_tok": 2,
                         "use_pad_tokens": True, "norm_topk_prob": True, "routed_scaling_factor": 1.0,
                         "moe_aux_loss_coeff": 0.01, "mtp_loss_factor": 0.3}
